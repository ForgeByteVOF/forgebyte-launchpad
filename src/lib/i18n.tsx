...
const translations: Record<Lang, Dict> = {
  nl: {
    ...
    "projects.title": "Word jij ons eerste project?",
    "projects.subtitle": "We staan te popelen om samen iets moois te bouwen. Jouw project kan hier binnenkort staan.",
    "projects.cta": "Neem contact op",
    ...
    "founder.tijn.tech": "TypeScript, React, Node.js, PostgreSQL, Tailwind",
  ...
  en: {
    ...
    "projects.eyebrow": "Portfolio",
    "projects.title": "Will you be our first project?",
    "projects.subtitle": "We are eager to build something great together. Your project could be featured here soon.",
    ...
    "founder.tijn.role": "Co-founder & Full-stack Developer",
    "founder.tijn.short": "Builds scalable systems and clean interfaces from frontend to backend.",
    "founder.tijn.long":
      "Tijn builds from frontend to backend. He combines clean design with solid engineering and makes sure everything feels intuitive.",
    "founder.tijn.skills": "Full-stack development, UI design, API integration, prototyping",
    "founder.tijn.tech": "TypeScript, React, Node.js, PostgreSQL, Tailwind",
